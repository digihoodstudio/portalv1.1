  ...
  try {
    ...
    if (!answer) {
      ...
      if (matchedKB) {
        ...
        last.includes("price") ||
        last.includes("cost") ||
        last.includes("pricing") ||
        last.includes("tier") ||
        last.includes("package") ||
        last.includes("plan")
      ) {
        answer =
          `We have three packages designed for real ROI:\n\n` +
          `• **Starter**: 24/7 AI receptionist, custom scripts, and weekly reports.\n` +
          `• **Growth**: Adds missed call recovery, CRM integration, and bi-weekly strategy calls (Our most popular!).\n` +
          `• **Dominance**: Includes everything, plus dead lead reactivation and a dedicated success manager.\n\n` +
          `Most clients see a full return on investment within 30 days. Which sounds like the right fit for your business?`;
      } else if (
        last.includes("guarantee") ||
        last.includes("roi") ||
        last.includes("result") ||
        last.includes("work") ||
        last.includes("worth")
      ) {
        answer =
        ...
        last.includes("demo") ||
        last.includes("consult") ||
        last.includes("appointment") ||
        last.includes("call")
      ) {
        answer =
          `Absolutely! I can help you schedule a free consultation:\n\n` +
        ...
        last.includes("miss") ||
        last.includes("call recovery") ||
        last.includes("missed call")
      ) {
        answer =
        ...
        last.includes("reactivat") ||
        last.includes("dead lead") ||
        last.includes("old lead") ||
        last.includes("cold")
      ) {
        answer =
          `Our **Dead Lead Reactivation** campaigns re-engage cold contacts:\n\n` +
        ...
        last.includes("receptionist") ||
        last.includes("inbound") ||
        last.includes("answer") ||
        last.includes("phone")
      ) {
        answer =
          `Our **24/7 AI Receptionist** handles inbound calls around the clock:\n\n` +
        ...
        answer = `Hello, welcome to Digihood Studio! I'm your AI growth consultant. I can walk you through our pricing, explain how our AI receptionist and missed call recovery works, or help you book a free consultation. What brings you here today?`;
      } else {
        answer = `Thanks for reaching out! Digihood Studio specialises in AI receptionists, missed call recovery, and lead reactivation for service businesses. Could you tell me a bit more about what you're looking to solve? Or I can book you a free 30-minute strategy call with our team right now.`;
      }
    }
