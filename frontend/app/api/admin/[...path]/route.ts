  ...
  if (path === "calls") {
    ...
    const defaultCalls = [
      {
        ...
        coaching: {
          ...
          sentiment: "Positive",
          coachingNotes:
            "Great call control. AI receptionist successfully handled emergency concerns.",
          transcript:
      ...
      },
      {
        ...
        coaching: {
          ...
          transcript:
            "[AI]: Hello, this is the callback assistant for Digihood Studio",
        },
      },
    ];
    const mapped = calls.map((c: any, i: number) => ({
      ...
      coaching: {
        ...
        sentiment: "Positive",
        coachingNotes:
          "AI responder handled lead qualifications with high script compliance.",
