...
export default function HeroSection() {
  ...
  return (
    <section
      id="home"
      className="relative overflow-hidden rounded-[20px] border border-white/[0.06] bg-[#080D26] p-6 md:p-12"
    >
      <div className="grid gap-12 lg:grid-cols-[1.35fr_0.9fr] lg:items-center">
        ...
        <div className="space-y-8">
          <motion.h1
            ...
            className="max-w-3xl text-3xl font-semibold leading-tight text-white sm:text-5xl md:text-6xl"
          >
            Your AI Workforce{' '}
        ...
        <div className="relative overflow-hidden rounded-[20px] border border-white/[0.06] bg-[#060E26] p-5">
          {/* Header */}
          <div className="mb-4 flex items-center justify-between">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-white/50">AI Control Center</p>
          ...
          {/* Waveform */}
          <div className="mb-4 rounded-2xl border border-white/[0.06] bg-[#040A1E] px-4 py-3">
            <div className="mb-2 flex items-center justify-between">
              <p className="text-[10px] uppercase tracking-[0.15em] text-white/40">Voice Agent — Live</p>
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.04] p-3">
            <p className="mb-2.5 text-[10px] uppercase tracking-[0.15em] text-white/40">Activity Feed</p>
      ...
      {/* Trust badges */}
      <div className="mt-10 pt-8 border-t border-white/[0.06] flex flex-wrap items-center justify-center lg:justify-between gap-6 text-[10px] font-semibold uppercase tracking-[0.15em] text-white/45">
